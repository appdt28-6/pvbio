                   ...
                   <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="productempty.php?id=<?php echo $id; ?>">Por agotar</a>
                                </li>
                                <li>
                                    <a href="bioconcept.php?id=<?php echo $id; ?>">Conceptos</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        include ('connect.php');
                                         ...
                                         $query = "SELECT codigoBarras,descripcion,precio FROM productos where idSublinea = 1 ";
