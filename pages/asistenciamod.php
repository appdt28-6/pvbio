    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
         ...
         <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Area de asistencia <?php echo date("d-m-y"); ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                   ...
                                   $query6 = "SELECT area,llegada FROM asistencias_clase where area='CLASE ZUMBA' and fecha BETWEEN '$fch1' AND '$fch2' ";
...
echo $cuenta;
            ...
            <div class="well">
                                ...
                                <a class="btn btn-default btn-lg btn-block" target="_self" href="detallessocios.php?id=<?php echo $id; ?>">Ver tabla de asitencia</a>
                            </div>
