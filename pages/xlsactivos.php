...
$sql = "SELECT socios.id_socio as id, socios.nombre as nombre,socios.ap as apellido,socios.membresia as membre,socios.telefono as tel, acceso.ultimopago as ultimo,acceso.vence as vence FROM acceso inner join socios on socios.id_socio=acceso.id_socio where acceso.status=1";
