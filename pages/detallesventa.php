                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										$ticket=$_GET['ticket'];
                                        include ('connect.php');                                  
                                         $query = "SELECT productos.descripcion as producto, ventasticket.cantidad as cantidad,ventasticket.presioUnitario as precio,ventasticket.importe as importe FROM `ventasticket` inner join productos on productos.idProducto=ventasticket.idProducto where idTicket= '$ticket' ";
                           ...
                           <!-- <div class="well">
                                ...
                                <a class="btn btn-default btn-lg btn-block" href="cancelarticket.php?ticket=<?php echo $ticket; ?>">Cancelar Ticket</a>
                            </div>-->
                        </div>
                        <!-- /.panel-body -->
                    </div>
