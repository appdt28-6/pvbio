                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        include ('../connect.php');
                                         ...
                                         $query = "SELECT idProducto,codigoBarras,descripcion,precio,stock FROM productos where idSublinea = 2 ";
                                   ...
                                   echo "<tr class=\"odd gradeX\">";
                                            ...
                                            echo "<td class=\"center\">".$row['precio']."</td>";
                                             echo "<td class=\"center\">".$row['stock']."</td>";
											  echo "<td class=\"center\"><a href=\"editproduct.php?id=".$row['idProducto']."\">Modificar</a></td>";
											  echo "<td class=\"center\"><a href=\"deleteproduct.php?id=".$row['idProducto']."\">Eliminar</a></td>";
