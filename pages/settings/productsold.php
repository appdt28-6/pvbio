        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <a href="javascript:print()" class="btn btn-primary">Imprimir</a>
                  <a href="../excel/ventas.php" class="btn btn-success">Excel</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-heading">
						  ...
						  <?php
                                ...
                                $fch2=date("Y-m-d")." 23:59:59";
                                     $query = "SELECT SUM(subtotal) as total FROM tickets where id_usuario='5' and tickets.tpago='0' and fecha BETWEEN '$fch1' AND '$fch2' ";
                        ...
                        <div class="panel-heading">
                         Ventas Turno Tarde
                           <?php
                                    ...
                                    $fch1=date("Y-m-d")." 00:00:00";
                                    $fch2=date("Y-m-d")." 23:59:59";
                                         $query = "SELECT SUM(subtotal) as total FROM tickets where id_usuario='4' and tickets.tpago='0' and fecha BETWEEN '$fch1' AND '$fch2' ";
                                  $result = mysql_query($query);
                                  while($row = mysql_fetch_array($result))
                                  {
