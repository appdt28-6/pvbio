...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">Egresos del mes <?php echo date("M"); ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Egresos Total: $   <?php
                                        include ('../connect.php');
										
                                        date_default_timezone_set('mexico/general');
                                         $query = " select sum(cantidad) as total from pagos where mes='$mes'";
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        include ('../connect.php');
                                        date_default_timezone_set('mexico/general');
                                         $query = " select * from pagos inner join gastos_fijos on pagos.concepto=gastos_fijos.id_gasto where pagos.mes='$mes'";
                                  $result = mysql_query($query);
                                  while($row = mysql_fetch_array($result))
                                  {
            ...
            <div class="well">
                                ...
                                <a class="btn btn-default btn-lg btn-block" target="_blank" href="tutorial/egresoreport.php">Imprimir</a>
                            </div>
