                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <?php
									   include('connect.php');
									 $id=$_GET['id'];
                                     $query = "SELECT * FROM pvbiogym.usuarios where idUsuario ='$id' ";
                                  $result = mysql_query($query);
                                  while($row = mysql_fetch_array($result))
                                  { ?>
                                    <form role="form" action="update_personal.php?id=<?php echo $row['idUsuario']; ?>" method="post">                                   
                               ...
                               <input name="tipoUsuario" class="form-control" value="<?php echo $row['tipoUsuario']; ?>">
                                      </div>
