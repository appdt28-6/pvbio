    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
           ...
           <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">Asistencias de:<?php echo $_POST['fecha']." a ".$_POST['fecha2']; ?> </h1>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                  ...
                                  <?php
								  //clase 8:15
								  $c1=$_POST['fecha']." 06:00:00";
								  $c2=$_POST['fecha2']." 08:30:00";
                                        include ('connect.php');
...
echo "8:15 <br> ".$cuenta." Socios";
                                  ...
                                  <?php
								  //clase 8:15
								  $c1=$_POST['fecha']." 08:31:00";
								  $c2=$_POST['fecha2']." 09:30:00";
                                        include ('connect.php');
...
echo "9:15 <br> ".$cuenta." Socios";
                                  ...
                                  <?php
								  //clase 8:15
								  $c1=$_POST['fecha']." 09:31:00";
								  $c2=$_POST['fecha2']." 18:30:00";
                                        include ('connect.php');
...
echo "18:15 <br> ".$cuenta." Socios";
                                  ...
                                  <?php
								  //clase 8:15
								  $c1=$_POST['fecha']." 18:31:00";
								  $c2=$_POST['fecha2']." 19:30:00";
                                        include ('connect.php');
...
echo "19:15 <br> ".$cuenta." Socios";
                                  ...
                                  <?php
								  //clase 8:15
								  $c1=$_POST['fecha']." 19:31:00";
								  $c2=$_POST['fecha2']." 20:30:00";
                                        include ('connect.php');
...
echo $cuenta." Socios";
            ...
            <div class="well">
            <a class="btn btn-default btn-lg btn-block" target="_blank" href="settings/tutorial/tuto2.php?f1=<?php echo $fch1;?>&&f2=<?php echo $fch2;?>">Imprimir</a>
                            </div>
