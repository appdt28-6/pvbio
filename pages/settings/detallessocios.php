        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">Detalles Socio</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <?php
                                  ...
                                  { ?>
                                    <form role="form" action="update_socio.php?id=<?php echo $row['id_socio']; ?>" method="post">                                  
                                       ...
                                       <label>Nombre</label>
                                       <input name="nombre" class="form-control" readonly value="<?php echo $row['nombre']; ?>">
                                      </div>
                                      
                                      <div class="form-group">
                                       <label>Apellido Paterno</label>
                                       <input name="ap"  readonly="readonly" class="form-control" value="<?php echo $row['ap']; ?>">
                                      </div>
                                      
                                      <div class="form-group">	
                                       <label>Apellido Materno</label>
                                       <input name="am" readonly class="form-control" value="<?php echo $row['am']; ?>">
                                      </div>
									   
                                        <div class="form-group">	
                                       <label>Fecha de Nacimiento</label>
                                       <input name="fechan" readonly class="form-control" value="<?php echo $row['fechan']; ?>">
                                      </div>
                                      
                                       <div class="form-group">	
                                       <label>Telefono</label>
                                       <input name="telefono" readonly class="form-control" value="<?php echo $row['telefono']; ?>">
                                      </div>
                                       
                                       
									    <div class=\"form-group\">
                                         <label>Email</label>
                                         <input name="email" readonly class="form-control" value="<?php echo $row['email']; ?>">
                                       </div>
                                       
                                        <div class="form-group">	
                                       <label>Dirección</label>
                                       <input name="direccion" readonly class="form-control" value="<?php echo $row['direccion']; ?>">
                                      </div>
                                       
                                        <div class="form-group">	
                                       <label>Calle y Número</label>
                                       <input name="calle" readonly class="form-control" value="<?php echo $row['calle']; ?>">
                                      </div>
                                      
                                         <div class="form-group">
                                         <label>Membresia</label>
                                         <input name="membresia" readonly class="form-control" value="<?php echo $row['membresia']; ?>">
                                       </div>
                                       
                                        <div class="form-group">	
                                       <label>Facebook</label>
                                       <input name="facebook" readonly class="form-control" value="<?php echo $row['facebook']; ?>">
                                      </div>
                                      
                                       
                                        <a href="socios.php"  class="tn btn-lg btn-warning btn-block">Salir</a>
