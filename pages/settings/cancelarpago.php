                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
										...
										$idpago=$_GET['pago'];
                                        include ('../connect.php');                                  
                                        $sql = mysql_query("DELETE FROM pagos WHERE id_pago='$idpago'");
if(! $sql )
{
  die('<div class="alert alert-danger">No pudimos cancelar la venta<a class="alert-link" href="#"></a></div>' . mysql_error());
}
echo "<div class=\"alert alert-success\">Pago Cancelado<a class=\"alert-link\" href=\"productsold.php\">Salir</a></div>";
mysql_close();
                                        ?>
