                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php
                                        include ('connect.php');
                                  $query = "SELECT * FROM gastos_fijos where mes='$mes' and id_gasto='$gasto'";
                                  $result = mysql_query($query);
                                  while($row = mysql_fetch_array($result))
                                  {?>
                               <form role="form" action="upd_variable.php?id=<?php echo $row['id_gasto']; ?>" method="post">
                                   
                                       <div class="form-group">
                                       <label>Concepto</label>
                                       <input name="concept" value="<?php echo $row['concepto'];?>" class="form-control">
                                      </div>
									    <div class=\"form-group\">
                                         <label>Importe</label>
                                         <input name="importe" value="<?php echo $row['importe'];?>" class="form-control" >
                                       </div>
                                       <br>
									    <div class="form-group">
                                         ...
                                         <select name="pago">
                                       <?php 
									   if($row['tipo']==0){echo "<option value=0>Efectivo</option>";}
									   else{echo "<option value=1>Cuenta Banc.</option>";};
									   ?>
                                       <option value="0">Efectivo</option>
                                       <option value="1">Cuenta Banc.</option>
                                      </select>
                                       </div>
                                        <div class="form-group">
