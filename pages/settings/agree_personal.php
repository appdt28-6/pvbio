...
<img src="../../images/logo.png" width="333" height="64">
                ...
                <div class="login-panel panel panel-default">
					...
					$sql = mysql_query("insert into pvbiogym.usuarios SET username='$username',password='$password',tipoUsuario='$tipoUsuario'");
					if(!$sql){
                        ...
                        echo "</div>";
							...
							?> 
                                ...
                                <a href="personal.php" class="tn btn-lg btn-warning btn-block">Salir</a>
