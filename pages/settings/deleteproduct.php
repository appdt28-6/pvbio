                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <?php
										$id=$_GET['id'];
                                        include ('connect.php');                                  
                                        $sql = mysql_query("DELETE FROM productos WHERE idProducto='$id' and idSublinea=2");
if(! $sql )
{
  die('<div class="alert alert-danger">No pudimos cancelar la venta<a class="alert-link" href="#"></a></div>' . mysql_error());
}
echo "<div class=\"alert alert-success\">Producto eliminado<a class=\"alert-link\" href=\"confiproducts.php\"> Salir</a></div>";
mysql_close();
                                        ?>
                            </div>
                            <!-- /.table-responsive -->
