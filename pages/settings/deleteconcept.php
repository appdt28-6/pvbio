...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header"> Conceptos de pagos</h1>
                 <p><a href="newconcept.php"><i class="fa fa-plus"></i> Nuevo</a></p>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <?php
										$id=$_GET['id'];
                                        include ('connect.php');                                  
                                          $sql = mysql_query("DELETE FROM productos WHERE idProducto='$id' and idSublinea=1");
if(! $sql )
{
  die('<div class="alert alert-danger">No pudimos borrar el concepto<a class="alert-link" href="#"></a></div>' . mysql_error());
}
echo "<div class=\"alert alert-success\">Concepto eliminado<a class=\"alert-link\" href=\"configconcept.php\">Salir</a></div>";
mysql_close();
                                        ?>
                            </div>
                            <!-- /.table-responsive -->
