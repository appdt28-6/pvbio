                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="agree_socio.php" method="post">
                                       ...
                                       <input name="nombre" class="form-control">
									    ...
									    <div class=\"form-group\">
                                         ...
                                         <input name="ap" class="form-control" >
                                       </div>
									    <div class="form-group">
                                         <label>Apellido Materno</label>
                                         <input name="am" class="form-control" >
                                       </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         <label>Tipo de Membresia</label>
                                          <input name="membresia" class="form-control" >
                                       </div>
