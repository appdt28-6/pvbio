                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Listado de gastos
                            <p><a href="newgastofijo.php"><i class="fa fa-plus"></i> Nuevo</a></p>
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                        include ('connect.php');
                                  $query = "SELECT * FROM gastos_fijos where mes='$mes' and tipo=0";
                                  ...
                                  while($row = mysql_fetch_array($result))
                                  {
							   	...
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-success" href="updatefijo.php?id='.$row['id_gasto'].'">Update</a>';
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-danger" href="deletefijo.php?id='.$row['id_gasto'].'">Delete</a>';
							   	echo '</td>';
