                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
										...
										$ticket=$_GET['ticket'];
                                        include ('../connect.php');                                  
                                        $sql = mysql_query("SET foreign_key_checks = 0").mysql_query("DELETE FROM tickets WHERE idTicket='$ticket'").mysql_query("SET foreign_key_checks = 1");
if(! $sql )
{
  die('<div class="alert alert-danger">No pudimos cancelar la venta<a class="alert-link" href="#"></a></div>' . mysql_error());
}
echo "<div class=\"alert alert-success\">Ticket Cancelado<a class=\"alert-link\" href=\"productsold.php\">Salir</a></div>";
mysql_close();
                                        ?>
