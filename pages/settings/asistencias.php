...
echo $cuenta." Socios";
            ...
            <!-- /.row -->
              ...
              <div class="well">
                                ...
                                <a class="btn btn-default btn-lg btn-block" target="_self" href="detalladoasis.php">Detallado de asistencias</a>
                            </div>
            <div class="well">
                                <h4>Detalle de socios</h4>
                               
                                <a class="btn btn-default btn-lg btn-block" target="_self" href="detallessocios.php">Crear Reporte</a>
                            </div>
