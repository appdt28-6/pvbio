...
<img src="../../images/logo.png" width="333" height="64">
                ...
                <div class="login-panel panel panel-default">
					...
					$sql = mysql_query("UPDATE productos SET codigoBarras='$barcode',descripcion='$producto',precio='$precio',stock='$total' where idProducto=$id");
					if(!$sql){
                        ...
                        echo "</div>";
							...
							?> 
                                ...
                                <a href="confiproducts.php" class="tn btn-lg btn-warning btn-block">Salir</a>
