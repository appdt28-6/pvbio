                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <?php
										$id=$_GET['id'];
                                        include ('connect.php');                                  
                                        $sql = mysql_query("DELETE FROM pvbiogym.pagos WHERE id_pago='$id'");
if(! $sql )
{
  die('<div class="alert alert-danger">No pudimos cancelar el pago<a class="alert-link" href="#"></a></div>' . mysql_error());
}
echo "<div class=\"alert alert-success\">Pago Cancelado<a class=\"alert-link\" href=\"pagos.php\"> Salir</a></div>";
mysql_close();
                                        ?>
                            </div>
                            <!-- /.table-responsive -->
