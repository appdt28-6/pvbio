...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">Ventas del mes <?php echo date("m");?></h1>
                <br>
                <a href="javascript:print()" class="btn btn-primary">Imprimir</a>
                  <a href="../excel/ventasall.php" class="btn btn-success">Excel</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <br>
             ...
             <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Acumulado de mes en ventas en efectivo:
						  <?php
                                    include ('connect.php');
                                    
                                     $query = "SELECT SUM(subtotal) as total FROM tickets where tpago='0' and fecha BETWEEN '$fch1' AND '$fch2' ";
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                         Acumulado de ventas con tarjeta:
                           <?php
                            include ('connect.php');
                             $query = "SELECT SUM(subtotal) as total FROM tickets where tickets.tpago='1'  and fecha BETWEEN '$fch1' AND '$fch2'";
                                  $result = mysql_query($query);
                                  while($row = mysql_fetch_array($result))
                                  {
                        ...
                        <div class="panel-heading">
                          Acumulado de salidas:
                             <?php
                               ...
                               $query = "SELECT SUM(cantidad) as total FROM pagos where fecha BETWEEN '$fch1' AND '$fch2' ";
                                  $result = mysql_query($query);
                                  while($row = mysql_fetch_array($result))
                                  {
                            ...
                            <div class="table-responsive">
                               <table class="table table-striped table-bordered table-hover">
                                    ...
                                    $fch2=date("Y-m-d")." 23:59:59";
                                         $query = "SELECT * FROM pagos where fecha BETWEEN '$fch1' AND '$fch2' ";
                                  $result = mysql_query($query);
                                  while($row = mysql_fetch_array($result))
                                  {
                                   echo "<tr class=\"odd gradeX\">";
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $fch1=date("Y-m-d")." 00:00:00";
                                    $fch2=date("Y-m-d")." 23:59:59";
                                         $query = "SELECT idTicket, subtotal,id_usuario FROM tickets where fecha BETWEEN '$fch1' AND '$fch2' ";
                                  $result = mysql_query($query);
                                  while($row = mysql_fetch_array($result))
                                  {
                                   echo "<tr class=\"odd gradeX\">";
                                            ...
                                            echo "<td class=\"center\">".$row['subtotal']."</td>";
											 echo "<td class=\"center\">".$row['id_usuario']."</td>";
