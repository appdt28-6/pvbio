                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        include ('../connect.php');
                                         ...
                                         $query = "SELECT idProducto,codigoBarras,descripcion,precio FROM productos where idSublinea = 1 ";
                                  ...
                                  while($row = mysql_fetch_array($result))
                                  {
                                   echo "<tr class=\"odd gradeX\">";
                                           ...
                                           echo "<td class=\"center\"><a href=\"editconcept.php?id=".$row['idProducto']."\">Modificar</a></td>";
											echo "<td class=\"center\"><a href=\"deleteconcept.php?id=".$row['idProducto']."\">Eliminar</a></td>";
                                        echo "</tr>";
                                  }
