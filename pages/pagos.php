...
<div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pago a terceros a <?php echo date("d-m-Y H:i:s");?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="reg_pago.php?id=<?php echo $id; ?>" method="post">
                                        <div class="form-group">
                                            ...
                                            <?php 
                                            /*include('connect.php'); 
											$query="Select * from gastos_fijos where mes='$mes'";
                                  ...
                                  while($row = mysql_fetch_array($result))
                                  {
									  ...
									  $fin=$row['importereal'];
									  $resta=$inicio-$fin;
									  if($resta==0){ //echo "<option>Nada</option>";
									  }
									  else{
										  if($fin==0){
											  echo "<option value=".$row['id_gasto'].">".$row['concepto']." $ ".$inicio."</option>";
											 }else{
												  echo "<option value=".$row['id_gasto'].">".$row['concepto']." por pagar ".$resta."</option>";
												 }
