...
<head>
	<meta charset="utf-8">
	<title>Editar Cliente||Qcompras</title>
		...
		<div class="page-full-width cf">
            ...
            <div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Editando Cliente</h3>
...
><div class="information-box round">Datos de RFC</div>
                  <br>
  ...
  <tr>
    <td width="28%"> Razón Social
                    <input type="text" name="razon" id="" class=""  size="30"/> </td>
                     <br>
    <td width="28%"> RFC
                    <input type="float" name="rfc" id="" class=""  size="30"/><br>     </td>
                    <br>
    <td width="28%">
                    C.P
                    <input type="float" name="cp" id="" class=""  size="20"/><br>  </td>
                    </tr>
                    </table>
                    <br>
  ...
  <tr>
   ...
   <td width="20%">  No. Interior
                    <input type="int" name="interior" id="" class=""  size="20"/><br> </td>
                    <br>
   <td width="20%">  No. Exterior
                    <input type="int" name="exterior" id="" class=""  size="20"/><br> </td>
                    </td>
                    </tr>
                    </table> 
                    <br>
  ...
  <tr>
   ...
   <td width="20%"> Estado
                    <input type="int" name="estado" id="" class=""  size="20"/><br> </td>
                    <br>
  <td width="20%">  Giro
                    <input type="int" name="giro" id="" class=""  size="30"/><br>  </td>
                    </td>
                    </tr>
                    </table> 
  ...
  ><div class="information-box round">Formas de pago</div>
                ...
                <select name="pago"> <option>Targeta </option> 
                <option> Efectivo</option>
                                </select>
                Cuanto deja en efectivo:
                 <input type="text" name="saldo" id="" class=""  size="20"/><br>
