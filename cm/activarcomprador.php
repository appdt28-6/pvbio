...
<head>
	<meta charset="utf-8">
	<title>Dashboard|Compradores</title>
...
<body>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				<li><a href="panel.php">Clientes</a></li>
		...
		<div class="page-full-width cf">
            ...
            <div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Lista de Compradores Registrados||Activos</h3>
...
$sts=1;
include('connect.php');
$sql = mysql_query("UPDATE clientes SET status='$sts' WHERE id_cliente='$ver'");
if(! $sql )
{
  die('<div class="error-box round">No se pudo dar de alta al comprador</div>' . mysql_error());
}
echo "<div class=\"confirmation-box round\">Comprador dado de ALTA</div>";
mysql_close();
