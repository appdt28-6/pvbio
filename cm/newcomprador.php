...
<body>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<a href="#" id="company-branding-small" class="fr"><img src="logo.png" alt="biogym" /></a>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
            ...
            <div class="content-module">
                ...
                <form action="reg_comprador.php" method="POST" id="">
                
			<fieldset>
                
  <div class="information-box round">Datos Personales</div>
 Tipo de Membresia:
						    	<select name="membre"><option>Todo incluido</option><option>Area de pesas</option><option>Zumba</option><option>Visita</option></select>
  <br>
  <p></p>
					Nombre:
					<input type="text" name="nombre" id="" class="" autofocus size="100"/>
                    <!--A. Paterno:
					<input type="text" name="ap" id="" class="" />
                    A. Materno:
					<input type="text" name="am" id="" class="" />-->
	<p></p>
      Teléfono:
					<input type="text" name="tel" id="" class="" />
                    Email:
					<input type="text" name="email" id="" class="" /><p></p>
                    
					Dirección:
                    <input type="text" name="direc" id="" class=""  size="100"/><br>
                    <p></p>
                    <div class="information-box round">Datos de Acceso</div>
                    
                    Usuario:
                    <input type="text" name="user" id="" class=""  size="100"/><br>
                    <p></p>
                    Contraseña:
                    <input type="pass" name="pass" id="" class=""  size="100"/>
