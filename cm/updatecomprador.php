		...
		<div class="page-full-width cf">
            ...
            <div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Editando Comprador</h3>
...
$ver=$_GET['id'];
include('connect.php');
$sql = mysql_query("UPDATE clientes SET nombre='$nom' ,telefono='$tel',email='$email',direccion='$direc',usuario='$user',contrasena='$pass' WHERE id_cliente='$ver'");
if(! $sql )
{
  die('<div class="error-box round">No se pudo actualizar Registro</div>' . mysql_error());
}
echo "<div class=\"confirmation-box round\">Registro actualizado con exito</div>";
mysql_close();
?>
