...
<body>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<li><a href="panelc.php">Socios</a></li>
				<li><a href="pagos.php" class="active-tab dashboard-tab">Salidas</a></li>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
            ...
            <div class="content-module">
                ...
                <form action="reg_pago.php" method="POST" id="">   
...
<div class="information-box round">Pagos</div>
  ...
  <tr>
    <td width="40%">Concepto:
					<input type="text" name="concep" id="" class="" autofocus size="50"/></p>
      </td> 
    <td>
    <td width="48%">Cantidad a Pagar:
					<input type="text" name="salida" id="" class="" autofocus size="50"/>
    </td>
    <td>
