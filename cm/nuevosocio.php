...
<body>
  ...
  <tr> 							  <?php include ('../pages/connect.php');
      							  $query = "SELECT MAX(id_socio) as id FROM socios";
                                  $result = mysql_query($query);
                                  while($row = mysql_fetch_array($result))
                                  {
									 echo" <td><label>ID:".($row['id']+1)."</label></td>";
                                  }
...
<select name="membre"><option>MENSUALIDAD ESTUDIANTE</option>
                         <option>MENSUALIDAD GYM</option>
                         <option>MENSUALIDAD TODO INCLUIDO</option>
                         <option>MENSUALIDAD ZUMBA</option>
                         <option>MENSUALIDAD HIP-HOP</option>
                         <option>MENSUALIDAD HAWAIANO</option>
                         <option>MENSUALIDAD COMPLETA</option>
                          <option>MENSUALIDAD MATRIMONIOS</option>
                         <option>ANUALIDAD 2X1</option></select></td>
    <td width="19%">
   Sexo:
                   <select name="gen">
                    <option>M</option>
    ...
    <td width="33%">Edad:
                    <input type="text" name="edad" id="" class=""autofocus size="4" /></td>
 					...
 					Nombre:
			  <input type="text" name="nombre" id="" class="" autofocus size="30"/>
              Apellido P:
			  <input type="text" name="ap" id="" class="" autofocus size="30"/>
              Apellido M:
			  <input type="text" name="am" id="" class="" autofocus size="30"/>
                   <p></p>
