...
$query = "SELECT * FROM clientes where id_cliente=$ver";
 ...
 <form action="updatemembre.php?id=<?php echo $row['id_cliente'];?>" method="POST" id="">
                
			<fieldset>
                
  <div class="information-box round">Datos Personales</div>
  Nombre del Cliente:
			  <input type="text" name="nombre" id="" class="" autofocus value="<?php echo $row["nombre"];?>" />
                    <p></p>
  Tipo de Membresia:
  <input type="text" value="<?php echo $row["membresia"];?>" />
  <p></p>
  Cambiar a:
  ...
  <br><p></p>
                ...
                <input type="submit" value="Guardar Cambios"class="button round blue image-right ic-right-arrow">
